...
try:
    import httpx
except ModuleNotFoundError:  # pragma: no cover - optional dependency in offline tests
...
class KiteService:
    ...
    def __init__(self) -> None:
        ...
        self._timeout = (
            httpx.Timeout(8.0, connect=5.0, read=8.0, write=5.0)
    ...
    async def fetch_quotes(
        ...
        if httpx is None:
            logger.warning("HTTPX not available; returning cached quotes only")
            return {}
    ...
    async def ping(self) -> tuple[bool, str]:
        ...
        if httpx is None:
            return False, "HTTPX not installed; cannot reach Kite APIs"
